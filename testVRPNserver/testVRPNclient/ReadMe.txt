========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet testVRPNclient
========================================================================

AppWizard a créé cette application testVRPNclient pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application testVRPNclient.


testVRPNclient.vcxproj
...
testVRPNclient.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé testVRPNclient.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
